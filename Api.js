...
const ProjectAPI = {
  projects: [
    ...
    { number: 6, name: "Premium Change", description: "cuatro", type: "Product Design", theme: "Canvas" },
    { number: 7, name: "okra", description: "cuatro", type: "Visual Design", theme: "Universe" },
    { number: 8, name: "MyPolicy Mobile App", description: "cuatro", type: "Visual Design", theme: "Universe" },
